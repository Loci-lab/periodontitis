...
def avgServer = new TransformedServerBuilder( getCurrentServer() ).extractChannels(1,2,3,4,7,8,9,13,14,16,17,18).averageChannelProject().build()
...
def pathModel = '/gpfs/gsfs11/users/perezriverosp/hiplex_oct_nov_2022/QUAPATH04_TrainCellpose_02/models/cellpose_residual_on_style_on_concatenation_off_train_2023_02_03_13_26_52.999803'
def cellpose = Cellpose2D.builder( pathModel )
        ...
        .tileSize(1024)                 // If your GPU can take it, make larger tiles to process fewer of them. 
